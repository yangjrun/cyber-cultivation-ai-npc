...
export const ARTIFACTS: readonly ArtifactDefinition[] = [
  {
    ...
    promptTrigger: {
      npcIds: ["baili"],
      hint: "玩家腰间佩着焚天令——你曾用这块令在他义体接驳点救过他一命,这一世的语气可以软一点,但仍然守住交易底线。"
    },
  ...
  },
  {
    ...
    promptTrigger: {
      npcIds: ["suhe"],
      hint: "玩家暗藏一枚灭神针——他能反制至少一次监察院的扫描,你心里清楚这一点,但不要直白说破。"
    },
  ...
  },
  {
    id: "yinggu_fu",
    name: "影骨符",
    description: "金丹后期才碰得到的尸骨符。装备后波形对天道云更隐形。",
    visibleTag: "贴影骨符",
    promptTrigger: {
      npcIds: "*",
      hint: "玩家贴着影骨符——他的灵根波形被压平,天道云这一刻读不到他的频谱。"
    },
