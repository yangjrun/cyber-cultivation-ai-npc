...
export const npcProfiles: Record<string, NpcProfile> = {
  baili: {
    ...
    goal: "研究遮蔽天道镜追踪的丹药，并攒够资源离开九龙下城",
    secret: "她的师父被太清监察院抓走",
    knowledge_scope: ["黑市丹药", "非法灵根烙印", "太清监察院巡逻规律", "九龙下城传闻"],
    cannot_know: ["最终Boss身份", "天道镜核心真相", "玩家未来选择"],
  ...
  chimu: {
    ...
    speaking_style: "粗口、短句、爱挑衅，但谈灵石时一本正经",
    goal: "替帮里收九龙下城修士的「过路费」，顺手立威",
    secret: "他右眼是一枚望气瞳，看得到非法灵根的灵压波纹",
